/*
 * To find connected objects in 3D image 
 */
using namespace std;
...
#define MAXPAIRS 100
#define MAXLABELS 40000	// 400000
#define MAXLABLIST 100		// 100
#define NBRS 26
#define MAXEXP 300
#define MAXOBJECTS 10000
#define NBIGOBJECTS 20
...
int max16 = pow(float(2),int(16))-1;
...
//	char *baseName;
	...
	if (argc != 5) {
		printf("Usage: connect input_tiff working base minvoxels\n");
		printf("       where: working is the working directory,\n");
		printf("              base is the base for output filenames,\n");
		printf("              e.g. if base = 'A' the output files are 'A00.tif', 'A01.tif', ...\n");
		printf("            : minvoxels is the minimum size of a connected object\n");
		fprintf(fp,"Usage: connect input_tiff working base minvoxels\n");
		fprintf(fp,"       where: working is the working directory,\n");
		fprintf(fp,"              base is the base for output filenames,\n");
		fprintf(fp,"              e.g. if base = 'A' the output files are 'A00.tif', 'A01.tif', ...\n");
		fprintf(fp,"            : minvoxels is the minimum size of a connected object\n");
	...
	working = argv[2]; 
	strcpy(outfile,working);
	strcat(outfile,"fibre_connecter.out");
