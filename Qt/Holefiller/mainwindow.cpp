    ...
    ui(new Ui::MainWindow)
{
    ...
    QString infoFile = QCoreApplication::applicationDirPath() + "/info/holefiller_info.txt";
	QFile file(infoFile);
...
void MainWindow::holefiller()
{
	int res;
    QString qstr, resultstr;
    char cmdstr[2048];

    qstr = QCoreApplication::applicationDirPath() + "/exec/holefill ";
	qstr += inputFileName;
	qstr += " ";
	qstr += outputFileName;
