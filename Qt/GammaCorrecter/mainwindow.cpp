    ...
    ui(new Ui::MainWindow)
{
	...
	QString infoFile = QCoreApplication::applicationDirPath() + "/info/gammacorrecter_info.txt";
	QFile file(infoFile);
...
void MainWindow::gammacorrecter()
{
	int res;
	QString qstr, resultstr;
	char cmdstr[256];

	qstr = QCoreApplication::applicationDirPath() + "/exec/gamma ";
	qstr += infileName;
	qstr += " ";
	qstr += outfileName;
	qstr += " ";
	qstr += ui->lineEditGamma->text();
